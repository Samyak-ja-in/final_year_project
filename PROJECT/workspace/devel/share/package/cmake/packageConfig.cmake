...
if("TRUE" STREQUAL "TRUE")
  set(package_SOURCE_PREFIX /home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/src/package)
  set(package_DEVEL_PREFIX /home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/devel)
  set(package_INSTALL_PREFIX "")
  set(package_PREFIX ${package_DEVEL_PREFIX})
else()
  set(package_SOURCE_PREFIX "")
  set(package_DEVEL_PREFIX "")
  set(package_INSTALL_PREFIX /home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/install)
...
if(NOT "/home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/devel/include " STREQUAL " ")
  set(package_INCLUDE_DIRS "")
  set(_include_dirs "/home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/devel/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'samyak01 <samyak01@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'package' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/src/package/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/devel/lib;/home/samyak01/Desktop/FINAL YEAR PROJECT /PROJECT/workspace/devel/lib;/home/samyak01/catkin_ws/devel/lib;/opt/ros/noetic/lib)
